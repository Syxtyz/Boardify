    ...
    <Dialog>
      <DialogTrigger asChild>
        <div className="w-full sm:w-64">
          <button className="h-8 w-full sm:w-8 bg-zinc-200 dark:bg-zinc-800 group cursor-pointer flex items-center overflow-hidden rounded-lg hover:w-full sm:hover:w-64 transition-[width]">
